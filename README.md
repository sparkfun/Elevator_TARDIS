...
* You'll also need a resistor for the LEDs, anything from 20 ohms to 100 ohms will work.
...
You will probably want to load the software (see below) and make sure everything works while it's sprawled out on a table. Once you know it works, you can mount everything in the box of your choosing using the standoffs and screws, hot glue, foam tape, etc.

###Installing the software:

####Install the Arduino IDE

If you haven't, you should [install the Arduino IDE](https://learn.sparkfun.com/tutorials/installing-arduino-ide) (Integrated Development Environment), available at http://www.arduino.cc.
...
Working versions of these libraries as of this date are included in this repository. You can download the repository by clicking the ["Download ZIP"](https://github.com/sparkfun/Elevator_TARDIS/archive/master.zip) button on the [repository's main page](https://github.com/sparkfun/Elevator_TARDIS).
...
*"To the rational mind, nothing is inexplicable, only unexplained"*<br>
- The Doctor.
